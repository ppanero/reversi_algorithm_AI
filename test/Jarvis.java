    ...
    public void run()
    {
        ...
        while (running && currentDepth < DEPTH_LIMIT)
        {
            ...
            if (newMove != null)
            {
                ...
                System.out.println("For depth " + currentDepth + ", selected move is " + selectedMove.toString());
            }
        }
        ...
        if (running) // Make a move if there is still time left.
        {
            ...
            System.out.println("Time remainging and hence doing move,  " + selectedMove.toString());
        }
    }
